...
(function () {
  ...
  var C_ACCENT = theme("--indigo", "#8A6400");        // session fill + trunk
  var C_DEEP   = theme("--indigo-deep", "#143A66");   // root fill
  var C_SOFT   = theme("--indigo-soft", "#B9CDE6");   // concept border
  var C_TINT   = theme("--indigo-50", "#EAF0F8");     // concept fill
  var C_INK    = theme("--ink", "#1B2430");           // concept text
  var C_FAINT  = theme("--faint", "#CDD6E2");         // twig edges
