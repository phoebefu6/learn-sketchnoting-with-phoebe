/* learn-sketchnoting-with-phoebe - shared page behavior
...
(function () {
  ...
  if (crumb && mastheadWrap) {
    ...
    if (m) {
      ...
      var pages = ["01-ideas-not-art.html", "02-five-shapes-one-vocabulary.html", "03-the-selection-bench.html", "04-seven-layouts-one-page.html", "05-readable-by-someone-else.html", "06-live-then-shared.html"];
...
(function () {
  "use strict";
  var PASSPORT_KEY = "lwp-passport:sketchnoting";
